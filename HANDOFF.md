...
1. H1 + 定价定位文案
2. Free / Pro / Max 价格卡 + 独立 Credit Packs 模块
3. 配额/积分/水印/分辨率/批量能力对比
4. FAQ（支付、退款、商用）
5. CTA：Choose Your Plan
...
- P1：素材版权状态未确认，可能卡上线
- P2：若 Pro / Max / Credit Pack 积分规则未锁定，定价页与计费文案需二次改版
